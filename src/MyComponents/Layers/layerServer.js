/* The code is defining a constant variable `layerServer` that stores the URL of a geoserver's Web Map
Service (WMS) endpoint. The WMS endpoint is used to retrieve map layers and their associated data
from the geoserver. The code exports the `layerServer` variable as the default value, which means it
can be imported and used in other parts of the codebase. */
