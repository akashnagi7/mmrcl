...
allows the user to draw and modify vector features such as polygons and lines on the map. The
component uses various interactions and styles from OpenLayers to handle the drawing and
modification of features. It also includes functionality to calculate the length and area of
features. The component receives props to customize the style and behavior of the vector layers. It
also includes functionality to update the vector layer data to a GeoJSON format. The component is
connected to the Redux store to manage the state of the vector layer properties. */
...
export default connect(mapStateToProps, mapDispatchToProps)(VectorLayersDraw);
