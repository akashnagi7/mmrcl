/**
 * The below code is a React component that handles drawing and measuring functionalities on a map.
 */
...
const Drawmeasure = (props) => {
  ...
  const handlevectormeasuretoggleChange = (event) => {
    const chklength = props.myname.filter(
      (person) => person.checked == true
    ).length;
    if (props.myvectordrawtoggle) {
      setLayerShow(true);
      ...
      setVectormeasuretoggle(!vectormeasuretoggle);
      props.changevectormeasuretoggle(!vectormeasuretoggle);
          ...
          >
            <div class="form-check">
              <input
                ...
                id="vectormeasuretoggle"
                checked={vectormeasuretoggle}
                onChange={handlevectormeasuretoggleChange}
              />
              <label class="form-check-label" for="vectormeasuretoggle">
                Measure Mode
              </label>
            </div>
          </div>
              ...
              <option value="Circle">Circle</option>
                ...
                >
                  ...
                  {/* <Tooltip title="Draw Point">
                    <ToggleButton id="tbg-radio-1" onClick={handlePoint} disabled={geometryType == "Point" ? false : true} >
                  ...
                  {/* <Tooltip title="Draw Circle">
                    <ToggleButton id="tbg-radio-4" onClick={handleCircle} disabled={geometryType == "Circle" ? false : true}>
...
export default connect(mapStateToProps, mapDispatchToProps)(Drawmeasure);
